...
<template>
    <App>
        ...
        <div class="bg-white dark:bg-gray-900">
            <div
                class="mx-auto flex flex-col w-full px-4 py-16 sm:px-6 sm:py-24 lg:px-8"
            >
                    ...
                    >
                        ...
                        >
                            <el-carousel-item
                                ...
                                v-for="(pimg, index) in product.product_images"
                                :key="index"
                            >
                                <img
                                    :src="pimg.image ? pimg.image : sampleImage"
                                    :alt="product.title"
                            ...
                            <div class="flex gap-2 items-center">
                                <div>
                                    <div
                                        ...
                                        class="bg-blue-600 p-2 rounded-full transition duration-200 hover:scale-110 hover:bg-blue-800"
                                    >
                                        <a
                                            v-if="auth.user"
                                    ...
                                    <div
                                        v-else
                                        class="bg-red-500 text-white px-2 py-0.5 rounded-lg"
                                    >
                                        Out of stock
                                    </div>
                                </div>
                ...
                <div data-aos="fade-left" class="mt-10 flex justify-end gap-3">
                    <Link
                        ...
                        class="cursor-pointer inline-flex transition hover:text-gray-700 duration-150 hover:scale-110"
                    >
