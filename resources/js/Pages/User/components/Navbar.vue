...
<template>
    <nav
        class="bg-white dark:bg-gray-800 fixed w-full z-20 top-0 start-0 scroll-smooth dark:border-gray-600"
    >
        <div
        ...
        >
            ...
            >
                ...
                <span
                    class="self-center text-sm lg:text-2xl font-semibold whitespace-nowrap dark:text-white"
                    >JKB Sample</span
                >
            </Link>
            <div
            ...
            >
                ...
                <button
                    @click="toggleDark()"
                    type="button"
                    class="focus:outline-none font-medium rounded-full font-semibold text-sm px-3 text-center inline-flex items-center mr-4"
                ...
                >
                    <span class="mr-2 capitalize md:block hidden mt-0.5">{{
                        auth.user.name
                    }}</span>
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
            ...
            >
                ...
                >
                    ...
                    <li v-if="auth">
                        <Link
                            :href="route('dashboard')"
                            class="block lg:hidden py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"
                            >Dashboard</Link
                        >
                    </li>
                    <li v-if="!auth">
